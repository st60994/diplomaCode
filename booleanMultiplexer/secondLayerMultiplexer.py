...
class SecondLayerMultiplexer:
    ...
    def __prepare_run(self):
       # creator.create("FitnessMax", base.Fitness, weights=(1.0,))
        ...
        toolbox.register("expr", gp.genGrow, pset=self.pset, min_=self.MIN_TREE_INIT_HEIGHT, max_=self.MAX_TREE_INIT_HEIGHT)
        ...
        toolbox.register("select", koza_over_selection, tournsize=self.TOURNAMENT_SIZE, population_size=self.POPULATION_SIZE)
